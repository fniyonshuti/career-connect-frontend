        ...
        <div className="mt-12 grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-6 mt-6">
              ...
              <a href="https://www.twitter.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 text-2xl">
                <i className="fab fa-twitter"></i> {/* Twitter Icon */}
              </a>
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 text-2xl">
